...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //涂鸦图片配置区
        ,scrawlUrl:URL+"/scrawlUp.jsp"           //涂鸦上传地址
        ...
        ,catcherUrl:URL +"/getRemoteImage.jsp"   //处理远程图片抓取的地址
        ...
        //图片在线管理配置区
        ,imageManagerUrl:URL + "/imageManager.jsp"       //图片在线管理的处理地址
        ,imageManagerPath:URL + "/"                                    //图片修正地址，同imagePath

        //屏幕截图配置区
        ,snapscreenHost: location.hostname                                 //屏幕截图的server端文件所在的网站地址或者ip，请不要加http://
        ,snapscreenServerUrl: URL +"/imageUp.jsp" //屏幕截图的server端保存程序，UEditor的范例代码为“URL +"server/upload/jsp/snapImgUp.jsp"”
        ,snapscreenPath: URL + "/"
        ,snapscreenServerPort: location.port                                   //屏幕截图的server端端口
        //,snapscreenImgAlign: ''                                //截图的图片默认的排版方式

        //word转存配置区
        ,wordImageUrl:URL + "/imageUp.jsp"             //word转存提交地址
        ,wordImagePath:URL + "/"                       //
        //,wordImageFieldName:"upfile"                     //word转存表单名若此处修改，需要在后台对应文件修改对应参数

        //获取视频数据的地址
        ,getMovieUrl:URL+"/getMovie.jsp"                   //视频数据获取地址
...
//           ]
        ...
        ,maximumWords:1000000000000       //允许的最大字符数
