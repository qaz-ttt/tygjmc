            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ol class="breadcrumb cb-breadcrumb">
                      ...
                      <li><a href="${ctx }/api/RecruitController.do?method=list">招聘信息</a></li>
            ...
            <div class="row">
                ...
                <div class="col-sm-9 cb-img-adapt">
                    <ul class="cb-newsread-box">
                        <li class="cb-title">${recruitContent.reruitName }</li>
                        <li class="cb-editTime">
                            <font><b>联系人</b>：${recruitContent.reruitMan }</font><font><b>截止时间</b>：${recruitContent.endTime}</font></li>
                        <li class="cb-content">
                           ${recruitContent.reruitContent}
                        </li>                   
                    </ul>
                </div>
            </div>
