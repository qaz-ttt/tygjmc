	...
	<section>
		<div class="container">
			...
			<div class="row"  style="margin-top: 35px;">
				<div class="col-md-12">
					<c:forEach items="${question }" var="data">
					<div class="job-new-list">
						
						<div class="vc-content">
							<h5 class="title">${data.questionTitle }<span>发布时间：${data.createDate }</span></h5>
							
							<ul class="vc-info-list">
							<li class="list-inline-item"><p style="color:red;font-size:20px;">${data.questionContent }</p></li>
		 ...
		 <!--[if !IE]>分页_End<![endif]-->
                ...
                <div class="col-sm-10">
                    <ul class="pagination cb-pagination">
                      <li><a href="${ctx }/api/questionMore.do?pageNum=${page.pageNum ==1 ? 1 :page.pageNum-1 }&pageSize=4">&laquo;</a></li>
                      <c:forEach var="p" begin="1" end="${page.pages }">
                      <li <c:if test="${page.pageNum == p}">class="active"</c:if>><a href="${ctx }/api/questionMore.do?pageNum=${p}&pageSize=4">${p}</a></li>
                      
                      </c:forEach>                  
                      <li><a href="${ctx }/api/questionMore.do?pageNum=${page.pageNum ==page.pages?page.pages:page.pageNum+1 }&pageSize=4">&raquo;</a></li>
                    </ul>
                </div>
