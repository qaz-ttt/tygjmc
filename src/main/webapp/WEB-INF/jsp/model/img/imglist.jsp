...
<script type="text/javascript">
	$(function() {
		...
		$("#tsys_manager_list").flexigrid({
			url : "${ctx}/imgController.do?method=query",// ajax方式对应的url地址
			type : 'post',// 数据发送方式 
		...
		$("#btn_edit").click(function() {
			...
			dialogFun = sy.modalDialog({
				...
				height : 300,
				resizable : true,
				url : '${ctx}/imgController.do?method=modify&imgId='+id
			});
		});
	...
	var btn_add = function() {
		dialogFun = sy.modalDialog({
			...
			height : 300,
			resizable : true,
			url : '${ctx}/imgController.do?method=jumpadd'
		});
	};
			...
			<div id="query_area">
				...
				<%-- <table class="FormView" border="0" cellspacing="1" cellpadding="0">
					...
					<tr>
						<td align="left">图片类型
						<td>
						<select name="imgType" value="imgType" id="imgType">
		                	<option value="">请选择</option>
		                	<c:forEach var="list" items="${imgType}">
