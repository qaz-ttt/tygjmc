...
<script type="text/javascript">
	$(function() {
		...
		$("#tsys_manager_list").flexigrid({
			...
			{display : '品牌id',name : 'brandId',width : 150,sortable : true,align : 'center'},
			{display : '审核id',name : 'auditId',width : 150,sortable : true,align : 'center'},
			{display : '汽车类型',name : 'carType',width : 150,sortable : true,align : 'center'},
			...
			{display : '价格区间',name : 'priceRange',width : 150,sortable : true,align : 'center'},
			...
			{display : '汽车详细内容',name : 'carContent',width : 150,sortable : true,align : 'center'},
			...
			<div id="query_area">
				...
				<table class="FormView" border="0" cellspacing="1" cellpadding="0">
					...
					<tr>
						...
						<td>
							<input type="text" name="post_postName" id="postName" class="text" value="">
						</td>
						<td align="left">
							创建人
						</td>
